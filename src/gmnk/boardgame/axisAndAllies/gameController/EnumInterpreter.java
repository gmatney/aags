...
public class EnumInterpreter {
	...
	public static final Transport             UNIT_PROFILE_TRANSPORT        = new Transport();
	...
	public static final AntiaircraftArtillery UNIT_PROFILE_ANTIAIRCRAFTGUN  = new AntiaircraftArtillery();
	public static final Factory               UNIT_PROFILE_FACTORY          = new Factory(); 
	...
	public static UnitProfile getUnitProfile(UnitName unit){
		switch(unit){
			...
			case TRANSPORT        : return UNIT_PROFILE_TRANSPORT;
			...
			case ANTIAIRCRAFTGUN  : return UNIT_PROFILE_ANTIAIRCRAFTGUN;
			case FACTORY          : return UNIT_PROFILE_FACTORY;
		}
